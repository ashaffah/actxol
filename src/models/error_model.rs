...
pub enum ApiErrorType {
    #[display("Internal server error. Try again after some time.")]
    InternalServerError,

    #[display("Bad request.")]
    BadRequest,

    #[display("User not found for the given ID")]
    UserNotFound,
    ...
    #[display("Validation error on field")] ValidationError {
...
impl ResponseError for ApiErrorType {
    ...
    fn error_response(&self) -> HttpResponse {
        ...
        match self {
            ...
            ApiErrorType::ValidationError { validation_error, object } => {
